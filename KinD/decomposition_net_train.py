...
train_low_data = []
train_high_data = []
train_low_data_names = glob('../VOC_Trainval/VOCdevkit/VOC2007/NewImages_train/*.jpg') 
train_low_data_names.sort()
train_high_data_names = glob('../VOC_Trainval/VOCdevkit/VOC2007/JPEGImages_train/*.jpg') 
...
eval_low_data = []
eval_high_data = []
eval_low_data_name = glob('../VOC_Trainval/VOCdevkit/VOC2007/NewImages_val/*.jpg')
eval_low_data_name.sort()
eval_high_data_name = glob('../VOC_Trainval/VOCdevkit/VOC2007/JPEGImages_val/*.jpg')
