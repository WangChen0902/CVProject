...
train_low_data = []
train_high_data = []
train_low_data_names = glob('../VOC_Trainval/VOCdevkit/VOC2007/NewImages_train2/*.jpg') 
train_low_data_names.sort()
train_high_data_names = glob('../VOC_Trainval/VOCdevkit/VOC2007/JPEGImages_train2/*.jpg') 
...
print(len(decomposed_low_i_data_480))
print(len(decomposed_high_i_data_480))
eval_adjust_low_i_data = decomposed_low_i_data_480[2201:2500]
eval_adjust_high_i_data = decomposed_high_i_data_480[2201:2500]

train_adjust_low_i_data = decomposed_low_i_data_480[0:2200]
train_adjust_high_i_data = decomposed_high_i_data_480[0:2200]

print('[*] Number of training data: %d' % len(train_adjust_high_i_data))
print('[*] Number of evaluating data: %d' % len(eval_adjust_low_i_data))
...
for epoch in range(start_epoch, epoch):
    ...
    if (epoch + 1) % eval_every_epoch == 0:
        ...
        for idx in range(len(eval_adjust_low_i_data)):
